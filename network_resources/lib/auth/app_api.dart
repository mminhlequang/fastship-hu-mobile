...
class _MyAppEndpoint {
  ...
  static String loginPhoneOtp() => "/api/v1/login_phone_otp";
...
abstract class MyAppApi {
  ...
  Future<NetworkResponse> loginPhoneOtp(Map<String, dynamic> data);
...
class MyAppApiImp extends MyAppApi {
  ...
  @override
  Future<NetworkResponse> loginPhoneOtp(Map<String, dynamic> data) async {
    return await handleNetworkError(
      proccess: () async {
        Response response = await AppClient().post(
          _MyAppEndpoint.loginPhoneOtp(),
          data: data,
        );
        return NetworkResponse.fromResponse(
          response,
